...
import HeaderCreateProgram from "./components/headerCreateProgram";
...
const validationSchema = Yup.object({
  ...
  ).uniqueProperty('itemGroup', 'must be unique').uniqueProperty('itemCode', 'must be unique'),
      ...
      >
        {({ values, touched, errors, isSubmitting, resetForm }) => {
          return (
            <Form>
              <FormContainer>
                <HeaderCreateProgram touched={touched} errors={errors} values={values}
                />
                <CustomerLevel touched={touched} errors={errors} values={values}
                />
                <DetailProgram touched={touched} errors={errors} values={values}
                />
                {
                  values.programType === "BONUS" ?
                    <ItemBonus touched={touched} errors={errors} values={values} />
                    : ''
                }
                <StickyFooter
